...
contract DougProtectionRewriting is Doug {
    ...
    function _addProtection(bytes32 _name, bool _perm)
    internal
    validateOverwrite(_name)
    returns(bool)
    {
    ...
    function addProtection(bytes32 _name, bool _perm)
    external
    returns(bool)
    {
        address _am = contracts["ActionManager"];
