...
//        // todo require(_tokensLimit > 0 && _tokensLimit <= totalSupplyCap); // Must have some available tokens
...
//        newSalesAgent.tokenLimit = _tokensLimit * EXPONENT;
//        newSalesAgent.tokenMinted = 0;
...
//        return salesAgents[_salesAgentAddress].tokenLimit;
//    }
//
...
//        return salesAgents[_salesAgentAddress].tokenMinted;
//    }
//
//    /// @dev Returns the token total currently minted by the sale agent
//    /// @param _salesAgentAddress The address of the token sale agent contract
